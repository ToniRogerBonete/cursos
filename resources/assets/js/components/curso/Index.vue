<template>
    <div>
        <div class="bg-white p-3 mb-5">
            ...
            <form>
                <div class="row d-print-none">
                    ...
                    <div class="form-group col text-right">
                        <a href="/painel/cursos/create" class="btn btn-success">
            ...
            <div class="row">
                <div class="col-md-12">
                    <table class="table table-hover table-bordered table-light small">
                        <thead>
                        <tr>
    ...
    export default {
        ...
        methods: {
            getCursos() {
                ...
                axios({
                    method: 'get',
                    url: '/api/curso?page=' + this.currentPage + '&filtro=' + this.filtro
                })
